...
import avatar from "../../../images/avatar/notify.png";
...
const Header = ({ onNote }) => {
	...
	const [count, setSCount] = useState(false);
	//For fix header
															...
															<li key={index}>
																...
																<div className="timeline-panel">
																	<div className="media me-2">
																		<img alt="images" width={30} src={avatar} />
																	</div>
																	<div className="media-body">
																		<h6 className="mb-1">{list.content}</h6>
																		<small className="d-block">{list.created_at}</small>
																	</div>
																</div>
															</li>
														))}
